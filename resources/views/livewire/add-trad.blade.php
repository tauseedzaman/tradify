<form wire:submit.prevent="save" class="row">
    ...
    <div class="form-group col-md-6 mx-auto my-3">
        ...
        <input id="market" placeholder="Market/Coin" class="form-control" type="text" required wire:model.lazy="market"
            name="market">
    </div>
    <div class="form-group col-md-6 mx-auto my-3">
    ...
    <div class="form-group col-md-6 mx-auto my-3">
        ...
        <input id="market" placeholder="Open Price" class="form-control" type="number" required wire:model.lazy="open_price"
            name="open_price">
    </div>
    <div class="form-group col-md-6 mx-auto my-3">
        <label for="amount">Position Amount <small><i class="text-info text-sm">(USDT)</i></small></label>
        <input id="amount" placeholder="Position Amount" class="form-control" type="number"
            required wire:model.lazy="amount" name="amount">
    </div>
    <div class="form-group col-md-6 mx-auto my-3">
